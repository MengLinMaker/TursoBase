[1.00ms] SELECT {{_params}}.* FROM `_params` WHERE `key`='settings' LIMIT 1
[0.00ms] SELECT {{_collections}}.* FROM `_collections`
...
[0.00ms] INSERT INTO `_migrations` (`applied`, `file`) VALUES (1708645601564988, '1679943780_normalize_single_multiple_values.go')
[0.00ms] SELECT count(*) FROM `_migrations` WHERE `file`='1679943781_add_indexes_column.go' LIMIT 1
[0.00ms] SELECT `name` FROM `sqlite_schema` WHERE (`type`='view') AND ([[name]] LIKE '\_temp\_%' ESCAPE '\')
[0.00ms] SELECT name FROM PRAGMA_TABLE_INFO('_collections')
[0.00ms] SELECT {{_collections}}.* FROM `_collections` WHERE type != 'view'
[0.00ms] SELECT * FROM sqlite_master WHERE type = "index" and sql is not null
[0.00ms] INSERT INTO `_migrations` (`applied`, `file`) VALUES (1708645601565187, '1679943781_add_indexes_column.go')
[0.00ms] SELECT count(*) FROM `_migrations` WHERE `file`='1685164450_check_fk.go' LIMIT 1
[0.00ms] 
			DELETE FROM {{_externalAuths}}
			WHERE [[collectionId]] NOT IN (SELECT [[id]] FROM {{_collections}})
		
[0.00ms] INSERT INTO `_migrations` (`applied`, `file`) VALUES (1708645601565232, '1685164450_check_fk.go')
[0.00ms] SELECT count(*) FROM `_migrations` WHERE `file`='1689579878_renormalize_single_multiple_values.go' LIMIT 1
[0.00ms] SELECT {{_collections}}.* FROM `_collections`
[0.00ms] UPDATE {{users}} set [[avatar]] = (
						CASE
							WHEN COALESCE([[avatar]], '[]') = '[]'
...
[0.00ms] INSERT INTO `_migrations` (`applied`, `file`) VALUES (1708645601565339, '1689579878_renormalize_single_multiple_values.go')
[0.00ms] SELECT count(*) FROM `_migrations` WHERE `file`='1690319366_reset_null_values.go' LIMIT 1
[0.00ms] SELECT {{_collections}}.* FROM `_collections`
[0.00ms] UPDATE {{users}} SET [[name]] = '' WHERE [[name]] IS NULL
[0.00ms] UPDATE {{users}} SET [[avatar]] = '' WHERE [[avatar]] IS NULL
[0.00ms] INSERT INTO `_migrations` (`applied`, `file`) VALUES (1708645601565446, '1690319366_reset_null_values.go')
[0.00ms] SELECT count(*) FROM `_migrations` WHERE `file`='1690454337_transform_relations_to_views.go' LIMIT 1
[0.00ms] SELECT {{_collections}}.* FROM `_collections` WHERE `type`='view' ORDER BY `created` ASC
[0.00ms] INSERT INTO `_migrations` (`applied`, `file`) VALUES (1708645601565502, '1690454337_transform_relations_to_views.go')
[0.00ms] SELECT count(*) FROM `_migrations` WHERE `file`='1691747913_resave_views.go' LIMIT 1
[0.00ms] SELECT {{_collections}}.* FROM `_collections` WHERE `type`='view' ORDER BY `created` ASC
[0.00ms] INSERT INTO `_migrations` (`applied`, `file`) VALUES (1708645601565554, '1691747913_resave_views.go')
[0.00ms] SELECT count(*) FROM `_migrations` WHERE `file`='1692609521_copy_display_fields.go' LIMIT 1
[0.00ms] SELECT {{_collections}}.* FROM `_collections`
[0.00ms] INSERT INTO `_migrations` (`applied`, `file`) VALUES (1708645601565636, '1692609521_copy_display_fields.go')
[0.00ms] SELECT count(*) FROM `_migrations` WHERE `file`='1701496825_allow_single_oauth2_provider_in_multiple_auth_collections.go' LIMIT 1
[0.00ms] CREATE UNIQUE INDEX IF NOT EXISTS _externalAuths_collection_provider_idx on {{_externalAuths}} ([[collectionId]], [[provider]], [[providerId]])
[0.00ms] DROP INDEX IF EXISTS _externalAuths_provider_providerId_idx
[0.00ms] INSERT INTO `_migrations` (`applied`, `file`) VALUES (1708645601565677, '1701496825_allow_single_oauth2_provider_in_multiple_auth_collections.go')
[0.00ms] SELECT count(*) FROM `_migrations` WHERE `file`='1702134272_set_default_json_max_size.go' LIMIT 1
[0.00ms] SELECT {{_collections}}.* FROM `_collections`
[0.00ms] INSERT INTO `_migrations` (`applied`, `file`) VALUES (1708645601565743, '1702134272_set_default_json_max_size.go')
